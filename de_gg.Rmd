...
params:
    bcbFile: "data_gg/bcb.rda"
    design: !r formula(~stage)
    alpha: 0.01
    lfc: 0
    outputDir: "."
---
...
countsDir <- file.path(outputDir, "results", "counts_gg")
deDir <- file.path(outputDir, "results", "differential_expression_gg")
```
